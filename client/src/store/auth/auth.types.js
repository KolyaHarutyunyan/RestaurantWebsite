export const authTypes = {
  sign:{
    in: "AUTH_TYPE_SIGN_IN",
    up: "AUTH_TYPE_SIGN_UP",
    out: "AUTH_TYPE_SIGN_OUT",
  },
  check:{
    email:"AUTH_TYPE_CHECK_EMAIL",
    verifyKey:"AUTH_TYPE_CHECK_VERIFY_KEY",
    isAuthed:"AUTH_TYPE_IS_AUTHED",
