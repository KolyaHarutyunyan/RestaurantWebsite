      ...
      <div className="active-plan-wrapper">
        <div className="first-section">
          ...
          <div className="items-wrapper">
            <div className="icon-wrapper"><Icons.Date /></div>
            <p className="standart-text">Started Date <span style={{ color: "#000000" }}>02/02.2022</span></p>
          </div>
          <div className="items-wrapper">
            <div className="icon-wrapper"><Icons.Status /></div>
            <p className="standart-text">Status <span style={{ color: "#54C762" }}>Paid</span></p>
          </div>
          <div className="items-wrapper">
            <div className="icon-wrapper"><Icons.Price /></div>
            <p className="standart-text">Price <span style={{ color: "#000000" }}>$25</span></p>
          </div>
        </div>
        ...
        <div className="second-section">
          ...
          <div className="flex-able-wrapper">
            <div className="first-wrap">
              <div className="items-wrapper">
                <div className="icon-wrapper"><Icons.CheckPayment /></div>
                <p className="features-text">Menu list with items (description ,ingredients)</p>
              </div>
              <div className="items-wrapper">
                <div className="icon-wrapper"><Icons.CheckPayment /></div>
