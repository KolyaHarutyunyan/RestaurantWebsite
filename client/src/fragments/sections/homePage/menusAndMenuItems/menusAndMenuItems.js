  ...
  return (
    <Container>
      <div className="container">
        <div className="reduce-paper-box">
        ...
        <Typography color="text" className="descr">
          Here are a few popular menu items with high resolution pictures that
          grab the customers attention. Using clear images for food presentation
          is one of the most important aspects of your menu.
        </Typography>
      </div>
      ...
      <div className="add-menu-button">
        <Button onClick={handleCreate}>Add Menu Free</Button>
      </div>
    </Container>
  );
};
