...
export const RestaurantPageSections = () => {
    ...
    return (
        <div
            style={{background: 'linear-gradient(to bottom,#ffffff,#fdfdfd,#fafafb,#f8f8f8,#f6f5f6,#f5f3f5,#f4f2f3,#f3f0f2,#f2eff1,#f1eef0,#f0edef,#efecee)'}}>
                            ...
                            {loading ?
                                ...
                                menus.length ? menus.map((menu, index) => (
                                    <MenuCard
                                        ...
                                        onRequestToEdit={() => open(MODAL_NAMES.MENU_FORM, {
                                            menuId: menu.id,
                                            menuInfo: menu
                                        })}
                                        onRequestToDelete={() => {
