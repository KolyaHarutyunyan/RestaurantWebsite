...
export const ConfirmPassword = ({ type, authToken }) => {
	...
	let [ userData, setUserData ] = useState((type) => (
		type === "verify" ? {
				[dataType.newPass]: { ...InputTypes.password, dataType: dataType.newPass, placeholder: "Password" },
			}
			: {
				[dataType.newPass]: { ...InputTypes.password, dataType: dataType.newPass, placeholder: "New Password" },
	...
	let Description = type ==="reset" ?<>Enter your new password.<br/> Use at least 8 characters, 1 upper case and 1 digit.</>:"Enter your password."
