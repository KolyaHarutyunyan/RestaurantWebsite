	...
	return (
		<Styled.CategoriesTitle>
			<Styled.DoubleBtnBlock>
				<Styled.DoubleBlockButton onClick={()=>changeTo("foods")} active={activeType==="foods"}>Foods</Styled.DoubleBlockButton>
				<Styled.DoubleBlockButton onClick={()=>changeTo("drinks")} active={activeType==="drinks"}>drinks</Styled.DoubleBlockButton>
			</Styled.DoubleBtnBlock>
